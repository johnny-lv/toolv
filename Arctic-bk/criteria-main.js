                ...
                if(objType == 'Vehicle') {
                    ...
                    vehicleCriteriableAttrsColl.fetch({
                        success:function(collection, response, options) {
                            collection.each(function(vehicleAttrs) {
                                if(vehicleAttrs.get('sCriteriable') != 'Yes') {
                                    collection.remove(vehicleAttrs);
                                }
                            });
                    ...
                    vehicleCriteriableAttrsColl.each(function(vehicleAttrs) {
                        $("#attrs").append("<option value='"+ vehicleAttrs.get('mData') +"'>"+ vehicleAttrs.get('sTitle') +"</option>");
                    });
                }
            });
